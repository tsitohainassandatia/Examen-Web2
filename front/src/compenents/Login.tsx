        ...
        <div className="bg-green-50 flex justify-center items-center h-screen">
            <div className="flex-row space-y-5 place-items-center bg-white text-center  shadow-[0_0_10px] shadow-gray-400 rounded-4xl py-5 px-3.5 w-min">
                ...
                <div className="text-left">
                    ...
                    <Link to='' className="text-emerald-700 underline">forgot password?</Link>
                </div>
                <button type="submit" className="bg-emerald-700 font-bold text-white text-center py-1 px-2.5 rounded-lg hover:scale-110 duration-200">Log in</button>
                <p>Log in or <Link to='/signup' className="text-emerald-700 underline">Sign up</Link></p>
            </div>    
        </div>    
    </>
    )
